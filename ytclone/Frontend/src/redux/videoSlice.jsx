...
export const videoSlice = createSlice({
    ...
    reducers:{
        ...
        incrementViews : (state, action) => {
            state.currentVideo.Views += action.payload; // Increment the views count
          },
        like:(state,action) =>{
...
export const {fetchStart,fetchSuccess,fetchFailure,like,dislike,incrementViews} = videoSlice.actions
